          ...
          <li>
            ...
            >
              <ul className="btn-toggle-nav list-unstyled fw-normal small">
                ...
                <li>
                  <Link to="/inventario/Comprasdetalle" className="nav-link text-white ms-4">
                    Detalle de compras
                  </Link>
                </li>
              </ul>
            ...
            >
              <ul className="btn-toggle-nav list-unstyled fw-normal small">
                ...
                <li>
                 ...
                 <li>
                  <Link to="/reportes/rventas" className="nav-link text-white ms-4">
                    Reporte de Ventas
                  </Link>
                </li>
                <li>
                  <Link to="/reportes/caja" className="nav-link text-white ms-4">
                    Reporte de Caja
                  </Link>
                </li>
              </ul>
